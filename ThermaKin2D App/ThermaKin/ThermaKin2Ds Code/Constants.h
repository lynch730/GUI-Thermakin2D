...
namespace Consts
{
	const int VERSION=7; // Version of the ThermaKin program
	...
	const int MAX_ELEM_COLM=2001; // Maximum number of elements in column of 2D object
	const int MAX_COLM=2001; // Maximum number of columns
	
	const int MAX_CMP=50; // Maximum number of components
	const int MAX_RXN=50; // Maximum number of reactions
